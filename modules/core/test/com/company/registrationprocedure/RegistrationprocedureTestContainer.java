package com.company.registrationprocedure;
...
public class RegistrationprocedureTestContainer extends TestContainer {

    public RegistrationprocedureTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/registrationprocedure/app.properties",
    ...
    public static class Common extends RegistrationprocedureTestContainer {

        public static final RegistrationprocedureTestContainer.Common INSTANCE = new RegistrationprocedureTestContainer.Common();
